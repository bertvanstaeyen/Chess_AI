...
class Piece:
    ...
    # Returns all horizontal moves for this piece. This should therefore only be used by the Rooks and Queen since
    # they are the only pieces that can move horizontally.
    ...
    # A move is not valid if it is out of bounds, or a piece of the same color is being eaten.
